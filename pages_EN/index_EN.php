...
<body>
    ...
    <header>
            ...
            <div class="header_text">
                <h1>Welcome <br>to Bobo Coffee</h1>
                <p>
                The place where casual elegance meets bohemian charm in the heart of the City of Light. 
                </p>
            </div>
    </header>
    ...
    <section class="valeurs">
        ...
        <div class="section_valeurs">
            <div class="valeur_article">
                ...
                <h3>Treats</h3>
                <p>Awaken your senses to an explosion of flavors in a place where indulgence is elevated to an art, and every bite is a symphony of pleasure.</p>
            </div>
            ...
            <div class="valeur_article">
                ...
                <h3>Sustainable and Local Commitment</h3>
                <p>Respect for nature is the essential ingredient in our recipes, to offer you a coffee that tastes good and is good for the planet.</p>
            </div>
            ...
            <div class="valeur_article">
                ...
                <h3>Solidarity and Conviviality</h3>
                <p>Together for a world without hunger. Here, every difference is a richness, every conversation is a discovery.</p>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <p class="para_gourmand">Our treats are prepared with care, highlighting flavors and textures to provide an exquisite taste experience.</p>
            ...
            <div class="card">
                ...
                <div class="informations_coffee">
                    ...
                    <div class="horaires">
                        <h4>Opening hour :</h4>
                        <ul>
                            <li>Monday au Friday : <br>de 8h à 19h</li>
                            <li>Saturday et Sunday : <br>de 9h30 à 19h</li>
                        </ul>
                    </div>
                </div>
            </div>
